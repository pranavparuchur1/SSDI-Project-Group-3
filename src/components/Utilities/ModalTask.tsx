...
const ModalCreateTask: React.FC<{
  ...
  const [priority, setPriority] = useState<"level1" | "level2" | "level3">(()=>{
    if (task) {
  ...
  return (
    <Modal onClose={onClose} title={nameForm}>
      <form
        className="h-fullflex flex-col stylesInputsField overflow-auto"
      ...
      >
        ...
        <label>
          Priority
          <select required value={priority} onChange={({ target }) => setPriority(target.value as "level1" | "level2" | "level3")}>
